...
@Component({
  selector: 'app-view-ngo-map',
  templateUrl: './view-ngo-map.component.html',
  styleUrls: ['./view-ngo-map.component.css']
})
export class ViewNgoMapComponent implements AfterViewInit {
